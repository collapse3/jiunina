      ...
      <div class="author-social">
        ...
        <ModuleTransition delay="0.04" duration="0.5">
          <div v-if="recoShowModule" class="socials">
            ...
            <a v-if="socials.bilibili" :href="socials.bilibili" title="bilibili" target="_blank"><i
                class="iconfont big reco-bilibili pink"></i></a>
            <a v-if="socials.twitter" :href="socials.twitter" title="Twitter" target="_blank"><i
                class="iconfont big reco-twitter blue"></i></a>
